...
public class QueueByArray {
    ...
    public void enQueue(int value) {
        ...
        } else if (isQueueEmpty()) { //If the com.github.murugeshkumark.dsa.queue is empty then we need to initialize beginning index
            beginningOfQueue = 0;
            topOfQueue++;
            arr[topOfQueue] = value;
            System.out.println("Successfully inserted " + value + " in the com.github.murugeshkumark.dsa.queue");
        } else { //if the com.github.murugeshkumark.dsa.queue already has some elements in it then no need to initialize beginning index
            topOfQueue++;
            arr[topOfQueue] = value;
            System.out.println("Successfully inserted " + value + " in the com.github.murugeshkumark.dsa.queue");
        }
    ...
    public void deQueue() {
        if (isQueueEmpty()) {
            ...
            System.out.println("Dequeued: " + arr[beginningOfQueue] + " from com.github.murugeshkumark.dsa.queue");
            beginningOfQueue++;
