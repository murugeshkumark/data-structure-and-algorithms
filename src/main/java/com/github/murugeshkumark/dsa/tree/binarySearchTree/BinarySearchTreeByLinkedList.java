...
public class BinarySearchTreeByLinkedList {
	...
	BinaryNode insert(BinaryNode currentNode, int value) {
		if (currentNode == null) { // if root com.github.murugeshkumark.dsa.node is blank then insert new com.github.murugeshkumark.dsa.node there
	...
	// Search a com.github.murugeshkumark.dsa.node in BST
